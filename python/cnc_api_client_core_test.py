...
if not cnc_info.has_data:
    ...
    print('plasma_power                     =', cnc_info.plasma_power)
    print('plasma_power_min                 =', cnc_info.plasma_power_min)
    print('plasma_power_max                 =', cnc_info.plasma_power_max)
    print('plasma_power_enabled             =', cnc_info.plasma_power_enabled)
    print('plasma_power_locked              =', cnc_info.plasma_power_locked)
    print('plasma_voltage                   =', cnc_info.plasma_voltage)
    print('plasma_voltage_min               =', cnc_info.plasma_voltage_min)
    print('plasma_voltage_max               =', cnc_info.plasma_voltage_max)
    print('plasma_voltage_enabled           =', cnc_info.plasma_voltage_enabled)
    print('plasma_voltage_locked            =', cnc_info.plasma_voltage_locked)
...
log_command('GET: WORK ORDER DATA (FIRST IN THE PREVIOUS LIST)')
#work_order_code = 'QM_241005_0001'
#work_order_code = 'QM_241005_0002'
